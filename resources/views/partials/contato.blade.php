    ...
    <div class="panel-heading">
        <h3 class="panel-title">
            ...
            <span class="pull-right">
                ...
                <a href="{{route('pessoa.destroy', ['id' => $pessoa->id]) }}" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Apagar"><i class="fa fa-minus-circle"></i></a>
            </span>
        </h3>
    </div>
